  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-6 bg-white rounded-3  pb-2 mt-5">
        ...
        <input type="text" class="form-control" placeholder="Fathur Rahman">
        ...
        <input type="text" class="form-control" placeholder="PT. Gacorr jaya jaya">
        <p class="text-dark mt-3">Message</p>
        <textarea class="form-control" placeholder="Sampaikan kebutuhan"></textarea>
